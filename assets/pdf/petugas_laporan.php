...
$no = 1;
$saya = $_SESSION['id'];
$query = "SELECT * FROM arsip,kategori,petugas WHERE arsip_petugas=petugas_id and arsip_kategori=kategori_id and arsip_petugas='$saya' and arsip.arsip_waktu_upload BETWEEN '$dari_tgl' AND '$sampai_tgl' ORDER BY arsip_nama ASC";
