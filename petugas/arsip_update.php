...
if (isset ($_POST['input_pesan'])) {
	$id_pesan = $_POST['kirim_pesan'];
	$nama_pesan = $_POST['nama_pesan'];
	$email_pesan = $_POST['email_pesan'];
	$isi_pesan = $_POST['isi_pesan'];
	$save = mysqli_query ($koneksi, "INSERT INTO pesan (id_pesan, nama_pesan, email_pesan, isi_pesan)
									VALUES ('', '$nama_pesan', '$email_pesan', '$isi_pesan')");
}
